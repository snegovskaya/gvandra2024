...
\begin{center}
	 {\large Выдана туристу \su{\Large\textbf{\textit{ Мироновой Наталье Сергеевне}}}{фамилия, имя, отчество}}
\end{center}
...
\resizebox{\textwidth}{!}{%
	\begin{tabular}{|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.14\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.13\linewidth}|}
		...
		\textbf{\textit{2024 август}}	&	\textbf{\textit{Западный Кавказ, Гвандра}}	&\textbf{\textit{пешеходный в горах}}	&	\textbf{\textit{пешком}}	&	\textbf{\textit{48.0}}	& \textbf{\textit{7}} & \textbf{\textit{вторая}} & \textbf{\textit{участие}} \\
		\hline	
	\end{tabular}%
}
...
\normalsize \textit{д.р. Учкулан~--- д.р. Кичкинакол Уллукёльский~--- \textbf{пер. Уллукёль Восточный (1А, 3050)}~--- т/б <<Глобус>>~--- д.р.Гондарай~--- д.р. Джалпаккол~--- \textbf{пер. Джалпаккол Сев. (1А, 3411)}~--- д.р. Мырды~--- а/л<<Узункол>>} 

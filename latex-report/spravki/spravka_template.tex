...
\resizebox{\textwidth}{!}{%
	\begin{tabular}{|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.13\linewidth}|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.12\linewidth}|>{\centering\arraybackslash}m{0.1\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.11\linewidth}|>{\centering\arraybackslash}m{0.13\linewidth}|}
		...
		\textbf{\textit{2024 август}}	&	\textbf{\textit{Западный Кавказ, Гвандра}}	&	\textbf{\textit{горный}}	&	\textbf{\textit{пешком}}	&	\textbf{\textit{111.0}}	& \textbf{\textit{13}} & \textbf{\textit{первая}} & \textbf{\textit{участие}} \\
		\hline	
	\end{tabular}%
}
...
\normalsize \textit{д.р. Учкулан~--- д.р. Кичкинакол Уллукёльский~--- \textbf{пер. Уллукёль Восточный (1А$^\star$, 3050)}~--- т/б <<Глобус>>~--- д.р.Гондарай~--- д.р. Джалпаккол~--- \textbf{пер. Джалпаккол Сев. (1А$^\star$, 3411)}~--- д.р. Мырды~--- а/л<<Узункол>>~--- д.р.Кичкинекол~--- д.р. Таллычат~--- \textbf{пер. Кичкинекол Малый (1А, 3206)}~--- д.р. Чунгур-Джар~--- \textbf{пер. Перемётный (1А, 3255)}~--- д.р. Танышхан~--- д.р. Чиринкол~--- стоянка <<Гвандра>>~--- д. р. Кубань~--- \textbf{пер. Хотютау (1А, 3546)}~--- лед. Большой Азау~--- ст.~<<Кругозор>>} 
...
\resizebox{\textwidth}{!}{%
	\begin{tabular}{|>{\centering\arraybackslash}m{0.12\linewidth}|>{\centering\arraybackslash}m{0.2\linewidth}|>{\centering\arraybackslash}m{0.12\linewidth}|>{\raggedright\arraybackslash}m{0.45\linewidth}|}
		...
		\textit{перевал}	&	\textit{Уллу-Кёль Восточный}	&	\textit{1А$^{\star}$}	&	\textit{высота 3050~м, скально-снежно-осыпной}	 \\
		\hline

		\textit{перевал}	&	\textit{Джалпаккол Северный}	&	\textit{1А$^{\star}$}	&	\textit{высота 3411~м, ледово-скально-осыпной}	 \\
		\hline	
...
\small Замечание руководителя о маршруте и участнике группы: \underline{\normalsize \textit{Интересно, что она там про меня напишет}}\hrulefill

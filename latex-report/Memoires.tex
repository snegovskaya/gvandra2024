...
title{Мемуары руковода и участников (РоманЪ)} 

\paragraph{День 1 (18.08): Заезд. Подъём в висячку Кичкинакола Уллукёльского}

Здесь будет история про нежрамшего Георгия 

\paragraph{День 2 (19.08): Подъём к озеру Гитче-Кёль. Подъём к озеру Уллу-Кёль} 

Процедура принятия решения: как рискнули и решили идти вверх.  

\paragraph{День 3 (20.08): Взятие Уллу-Кёля Восточного.} 

\paragraph{День 4 (21.08): Выход к т\б Глобус. Сход Георгия. Ночной подъём} 

\paragraph{День 5 (22.08): Подход под Джалпакол} 

\paragraph{День 6 (23.08): Взятие Джалпакола} 
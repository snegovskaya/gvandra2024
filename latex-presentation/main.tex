...
\subtitle{чё-нить мемное сюды} % Presentation subtitle, remove this command if a subtitle isn't required
...
\end{frame}
	...
	\begin{frame}
		...
		\end{enumerate}
	\centering
	\includegraphics<1>[height=0.5\textheight]{../pics/portraits/vika}%
	\includegraphics<1>[height=0.5\textheight]{../pics/portraits/vika}%
	...
	\begin{frame}
		\frametitle{Трек}
		\rotatebox{90}{
			\includegraphics[width=0.68\linewidth]{../pics/map}}		
	\end{frame}
